...
function uploadfile($file_info,$uploaddir,$allowExt = array('jpeg', 'jpg', 'gif', 'png','bmp')){
...
foreach ($files as $filesInfo) {
    ...
    $res = uploadfile($filesInfo,'./image/'.$timenamefolder.'/');
...
header('location:tutorial2.php?img_index=./image/'.$timenamefolder.'/'.$files[0]['name'].'&timenamefolder='.$timenamefolder);
?>